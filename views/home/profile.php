        ...
        <div class="col-lg-6">
            ...
            <div class="card-body text-center">
                    ...
                    <img src="<?= $user->getProfilePicture()
                        ...
                        ?>" alt="Profile Picture" class="rounded-circle mb-3 mt-2" width="120" height="120"
                    ...
                    <?php if ($isMaxed): ?>
                        <div class="progress bg-secondary" style="height: 25px;">
                            ...
                            <span class="progress-bar-text position-absolute start-50 translate-middle-x text-light"
                    ...
                    <form method="post" action="/profile/update-pfp" enctype="multipart/form-data" class="mb-4">
                        <div class="mb-3 text-start">
                            <label for="pfp" class="form-label">Update Profile Picture</label>
                            <input type="file" class="form-control bg-dark text-light border-secondary" id="pfp"
                                name="pfp" accept="image/*" required>
                        </div>
